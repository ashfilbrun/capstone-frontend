...
const userProfile = () => {
      ...
      const getUser = async () => {
            try {
                  const response = await axios.get(`http://localhost:3001/api/user/${_id}`)
    ...
    <div>
      <div className="updateProfileForm" onSubmit={handleSubmitProfile}>
            ...
            <form>
                  ...
                  <input type="text" name="illnessId" value={illness} onChange={(e) => setIllnessId(e.target.value)} placeholder={user.illnessId}/>
